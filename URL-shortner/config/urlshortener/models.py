...
class Shortener(models.Model):
    ...
    """
    The Meta inner class, tell us how the class must behave, 
    and we set that the ordering (calling Shortener.objects.all())
    of the shortener objects will be discriminated by the most recent ones
    """
